    ...
    return (
        <>
            <Container>
                ...
                <Row>
                    <Col>
                        <ul className={currentBalance >= 0 ? 'text-success fw-bold' : 'text-danger fw-bold'}>
                            Current Balance: {currentBalance}</ul>
                    </Col>
                </Row>
                <Row>
                    <Col>
