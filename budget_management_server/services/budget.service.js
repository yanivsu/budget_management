...
module.exports.createTransactionService = async (transaction) => {
    if (!transaction.transaction_name || !transaction.amount || !transaction.type || !transaction.date) {
        console.log(`name: ${transaction.transaction_name} , amount: ${transaction.amount} , type: ${transaction.type}, date: ${transaction.date}`)
